...
substrate.parameters = function(DS="bio.substrate", p=NULL, resolution="canada.east.highres", nc=1) {
  ...
  if (DS=="sthm") {
    ...
    p$sthm_engine = "gam" # see model form in sthm.r (method="xyts")
    ...
    # p$sthm_engine_modelformula = formula( substrate ~ -1 + intercept
